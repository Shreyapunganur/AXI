...
module axi4_tb_top;
    ...
    axi4_top dut (
        ...
        .m0_cmd_write(m0_cmd_write),
        .m0_cmd_id(m0_cmd_id),
        .m0_cmd_addr(m0_cmd_addr),
        .m0_cmd_len(m0_cmd_len),
        .m0_cmd_burst(m0_cmd_burst),
        .m0_cmd_wstrb(m0_cmd_wstrb),
        .m0_cmd_wseed(m0_cmd_wseed),

        .m0_rsp_b_valid(m0_rsp_b_valid),
        .m0_rsp_b_id(m0_rsp_b_id),
        .m0_rsp_b_resp(m0_rsp_b_resp),
        .m0_rsp_r_valid(m0_rsp_r_valid),
        .m0_rsp_r_id(m0_rsp_r_id),
        .m0_rsp_r_resp(m0_rsp_r_resp),
        .m0_rsp_r_data(m0_rsp_r_data),
        .m0_rsp_r_last(m0_rsp_r_last),

        .m1_cmd_valid(m1_cmd_valid),
        .m1_cmd_ready(m1_cmd_ready),
        .m1_cmd_write(m1_cmd_write),
        .m1_cmd_id(m1_cmd_id),
        .m1_cmd_addr(m1_cmd_addr),
        .m1_cmd_len(m1_cmd_len),
        .m1_cmd_burst(m1_cmd_burst),
        .m1_cmd_wstrb(m1_cmd_wstrb),
        .m1_cmd_wseed(m1_cmd_wseed),

        .m1_rsp_b_valid(m1_rsp_b_valid),
        .m1_rsp_b_id(m1_rsp_b_id),
        .m1_rsp_b_resp(m1_rsp_b_resp),
        .m1_rsp_r_valid(m1_rsp_r_valid),
        .m1_rsp_r_id(m1_rsp_r_id),
        .m1_rsp_r_resp(m1_rsp_r_resp),
        .m1_rsp_r_data(m1_rsp_r_data),
        .m1_rsp_r_last(m1_rsp_r_last)
    );
    ...
    task automatic issue_m0(
        ...
        if (is_write)
            sb.predict_write(slave_idx, addr, len, burst, wstrb, seed);
        else
            sb.predict_read(0, id, slave_idx, addr, len, burst);
        ...
        if (first_issue_time == 0)
            first_issue_time = $time;
    ...
    task automatic issue_m1(
        ...
        if (is_write)
            ...
            sb.predict_read(1, id, slave_idx, addr, len, burst);
    ...
    bit [1:0] next_id_m0 = 0;
    bit [1:0] next_id_m1 = 0;
    ...
    initial begin
        ...
        for (int i = 0; i < 60; i = i + 1) begin
            ...
            if (use_m1) begin
                ...
                issue_m1(
                    ...
                    txn.burst,
                    txn.wstrb,
                    {24'h0, next_id_m1, txn.word_addr[5:0]}
                    ^ 32'h5A5A_0000
                );
                ...
                issue_m0(
                    ...
                    txn.burst,
                    txn.wstrb,
                    {24'h0, next_id_m0, txn.word_addr[5:0]}
                    ^ 32'hA5A5_0000
                );
        ...
        $display(
            " transactions issued : %0d  (M0=%0d, M1=%0d)",
            total_txns,
            m0_txns,
            m1_txns
        );
